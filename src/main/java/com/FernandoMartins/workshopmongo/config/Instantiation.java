...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, sdf.parse("10/10/2023"),"Partiu voyage", "estou indo viajar", maria);
		Post p2 = new Post(null, sdf.parse("12/12/2022"),"Olá, boa tarde!", "Como vcs estão?", maria);
